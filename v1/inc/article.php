<article class="tip<?php if($announcement == true) { ?> tip-announcement<?php } ?><?php if($faded == true) { ?> js-faded<?php } ?>">
	...
	<div class="tip-author">by <a href="<?php if($author == "Christian Krammer") { ?>http://chriskrammer.com<?php } elseif ($author == "Justin White") { ?>http://www.uxcandy.net/<?php } elseif ($author == "Alex Wu") { ?>http://au.linkedin.com/in/ahjwu<?php } ?>"><?php echo $author; ?></a></div>
