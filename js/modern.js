...
var hideMenuOutside = function(e) {
	...
	if (clicked.is('.tip-menu') || clicked.parents().is('.tip-menu') || clicked.is('.tip-title a')) { // Only close menu if none of these elements is clicked
		return;
...
$('.main-main-in').on('click', '.tip-title > a', function(e) { // Show menu on click on title
